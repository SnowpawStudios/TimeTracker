...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20240225220350_InitialCreate'
)
BEGIN
...
BEGIN
    ...
    VALUES (N'20240225220350_InitialCreate', N'8.0.2');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20240308213650_Projects'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20240308215405_UserProjectsRelation'
)
BEGIN
